...
//                   : RefreshIndicator(
//                       onRefresh: _fetchOverdueCustomers,
//                       child: overdueCustomers.isEmpty
//                           ? const Center(
//                               child: Text(
...
import '../../controllers/details_controller.dart';
import '../../controllers/customer_controller.dart';
import '../../controllers/search_controller.dart'; // ✅ Added
import '../../models/storage_models.dart';
import '../../config/app_routes.dart';
...
class _OverdueScreenState extends ConsumerState<OverdueScreen> {
  ...
  Future<void> _searchOverdue(String query) async {
    if (query.isEmpty) {
      _fetchOverdueCustomers();
      return;
    }
    ...
    await controller.searchCustomers(
      context: context,
      search: query,
      status: "Overdue", // ✅ Filter by overdue
    );
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              onChanged: _searchOverdue, // ✅ live search
              decoration: InputDecoration(
                hintText: 'Search overdue customers by name or phone',
                prefixIcon: const Icon(Icons.search),
                filled: true,
                fillColor: Colors.grey.shade100,
                border: OutlineInputBorder(
